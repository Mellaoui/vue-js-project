<template>
	<div class="justify-center pt-20 md:flex md:flex-col lg:flex-row lg:h-screen md:justify-evenly">
		<div class="flex flex-col items-center w-full my-3 lg:w-1/3">
			<div id="production" class="flex-col hidden w-full p-3 my-3 sm:flex md:divide-solid gap-y-6">
				<h3 class="text-base">Production</h3>
				<div class="grid md:pl-12 lg:pl-2 md:gap-24 lg:gap-3 md:grid-cols-5 lg:grid-cols-3">
					<div class="flex flex-col items-center gap-y-2">
						<div class="flex items-center justify-center w-24 h-24 bg-red-400 rounded-2xl">
							<img src="@/assets/icons/barcode-reader.png" alt="" />
						</div>
						<div class="text-sm text-center w-14">Data Capture</div>
					</div>
					<div class="flex flex-col items-center gap-y-2">
						<div class="flex items-center justify-center w-24 h-24 bg-gray-100 rounded-2xl">
							<!-- img here -->
						</div>
						<div class="text-sm text-center w-14">Stock Search</div>
					</div>
					<div class="flex flex-col items-center gap-y-2">
						<div class="flex items-center justify-center w-24 h-24 bg-gray-100 rounded-2xl"></div>
			...
			<div id="production-mobile" class="inline-block w-2/3 pl-6 text-left sm:relative md:hidden">
				<div class="flex justify-center w-full">
					<button
						type="button"
						class="inline-flex justify-between px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 shadow-sm rounded-2xl w-80 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500"
						id="menu-button"
						aria-expanded="true"
						aria-haspopup="true"
					>
  ...
  -->
				...
				>
					...
					<div class="flex flex-col items-center gap-y-2">
						<div class="w-20 h-20 p-3 bg-red-400 rounded-2xl">
							<img src="@/assets/icons/barcode-reader.png" alt="" />
						</div>
						<div class="text-sm text-center w-14">Data Capture</div>
					</div>
			...
			<div id="hr-mobile" class="inline-block w-full pl-6 text-left sm:relative md:hidden">
				<div class="flex justify-center w-full">
					<button
						type="button"
						class="inline-flex justify-between px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 shadow-sm rounded-2xl w-80 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500"
  ...
  -->
		...
		<div class="flex flex-col items-center w-full my-3 lg:w-1/3">
			<div id="goods-management" class="flex-col hidden w-full p-3 my-3 sm:flex gap-y-6">
				...
				<div class="grid grid-cols-3 gap-3">
					...
					<div class="flex flex-col items-center gap-y-2">
						<div class="flex items-center justify-center w-24 h-24 bg-blue-500 rounded-2xl"></div>
			...
			<div id="goods-management-mobile" class="inline-block w-full pl-6 text-left sm:relative md:hidden">
				<div class="flex justify-center w-full">
					<button
						type="button"
						class="inline-flex justify-between px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 shadow-sm rounded-2xl w-80 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500"
  ...
  -->
			...
			<div id="stock-management" class="flex-col hidden w-full p-3 my-3 sm:flex gap-y-6">
			...
			<div id="stock-management-mobile" class="inline-block w-full pl-6 text-left sm:relative md:hidden">
				<div class="flex justify-center w-full">
					<button
						type="button"
						class="inline-flex justify-between px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 shadow-sm rounded-2xl w-80 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500"
